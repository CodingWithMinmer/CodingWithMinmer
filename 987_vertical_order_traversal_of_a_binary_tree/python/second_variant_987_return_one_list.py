...
class Solution_987_Second_Variant:
    ...
    def vertical_traversal(self, root: Optional[TreeNode]) -> List[List[int]]:
        ...
        for col in range(leftmost_col, rightmost_col + 1):
            ...
            result += [node[0].val for node in curr_col]
...
if __name__ == "__main__":
    ...
    assert Solution_987_Second_Variant().vertical_traversal(root) == [
        3,
        8,
        1,
        16,
    ...
    assert Solution_987_Second_Variant().vertical_traversal(root) == [9, 3, 15, 20, 7]
