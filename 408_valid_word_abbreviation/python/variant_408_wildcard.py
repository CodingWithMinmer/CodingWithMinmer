...
def recurse(word: str, abbr: str, w: int, a: int) -> bool:
...
if __name__ == "__main__":
    ...
    assert valid_word_abbreviation("hellzpme", "h2*p*me") == True
    assert valid_word_abbreviation("test", "tes") == False
    assert valid_word_abbreviation("test", "tes***") == True
    assert valid_word_abbreviation("test", "tes***s") == False